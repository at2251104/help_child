...
urlpatterns=[
    ...
    path('contactUpdate_oya/<str:pk>/',views.ContactUpdateOyaView.as_view(), name="contactUpdate_oya"),
    ...
    path('childminder2Update/<pk>/',views.Childminder2UpdateView.as_view(),name="childminder2Update"),
