    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='ID', max_length=150, verbose_name='名')),
                ('last_name_kana', models.CharField(default='ID', max_length=150, verbose_name='姓（かな）')),
                ('first_name_kana', models.CharField(default='ID', max_length=150, verbose_name='名（かな）')),
                ('sex', models.CharField(choices=[('男性', '男性'), ('女性', '女性')], default='ID', max_length=4, verbose_name='性別')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('class_id', models.CharField(default='ID', max_length=3, verbose_name='クラスID')),
                ('administator', models.BooleanField(default=False, verbose_name='管理者')),
